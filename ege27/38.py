...
def visual(clasters):
    turtle.up()
    turtle.tracer(0)
    colors = ["red","pink","orange","black","yellow"]
...
data = [list(map(float,line.split()))for line in open("27data/27-38a.txt")]
...
data = [list(map(float,line.split()))for line in open("27data/27-38b.txt")]
clasters = clasterizasion(data,1)
