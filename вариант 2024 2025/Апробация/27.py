...
def visual(clasters):
    turtle.up()
    turtle.tracer(0)
    colors = ["red","yellow","blue","grey","green","purple"]
...
data = [list(map(float,line.split())) for line in open("27_A_20816.txt")]
...
data = [list(map(float,line.split())) for line in open("27_B_20816.txt")]
